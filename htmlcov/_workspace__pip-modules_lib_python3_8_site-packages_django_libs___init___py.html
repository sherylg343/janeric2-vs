...
<head>
    ...
    <title>Coverage for /workspace/.pip-modules/lib/python3.8/site-packages/django_libs/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/workspace/.pip-modules/lib/python3.8/site-packages/django_libs/__init__.py</b> :
...
<div id="source">
    ...
    <p id="t2" class="run"><span class="n"><a href="#t2">2</a></span><span class="t"><span class="nam">__version__</span> <span class="op">=</span> <span class="str">'2.0.3'</span>&nbsp;</span><span class="r"></span></p>
</div>
<div id="footer">
    <div class="content">
        <p>
